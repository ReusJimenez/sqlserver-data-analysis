...
-- Visualizamos los procedimientos almacenados que empiecen con PA
...
-- SUBSTR(): Devuelve una parte de una cadena, basada en una posición inicial y una longitud.
...
-- Usando una sentencia anónima PL/SQL para trabajar con el cursor retornado
SET SERVEROUTPUT ON
DECLARE
    empleados_cursor SYS_REFCURSOR;
...
-- Funciones con Manipulación de Cadenas
